...
{
    public class DashboardR101Model : BasePageModel
    {
        private readonly ILogger<DashboardR101Model> _logger;
        ...
        public DashboardR101Model(ILogger<DashboardR101Model> logger, Supabase.Client client)
        {
            _logger = logger;
            _supabase = client;
        }
