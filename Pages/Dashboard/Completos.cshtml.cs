...
{
    public class DashboardCompletosModel : BasePageModel
    {
        private readonly ILogger<DashboardCompletosModel> _logger;
        ...
        public DashboardCompletosModel(ILogger<DashboardCompletosModel> logger, Supabase.Client client)
        {
            _logger = logger;
            _supabase = client;
        }
