...
{
    public class DashboardR85Model : BasePageModel
    {
        private readonly ILogger<DashboardR85Model> _logger;
        ...
        public DashboardR85Model(ILogger<DashboardR85Model> logger, Supabase.Client client)
        {
            _logger = logger;
            _supabase = client;
        }
